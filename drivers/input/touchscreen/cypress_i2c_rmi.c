...
void init(void)
{
	...
	gpio_direction_output(GPIO_TOUCH_EN_OUT, 1);
	gpio_tlmm_config(GPIO_CFG(SCLK_GPIO, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(SDATA_GPIO, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA), GPIO_CFG_ENABLE);
}

void reset (void)
{
	gpio_tlmm_config(GPIO_CFG(SCLK_GPIO, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(SDATA_GPIO, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_direction_output(GPIO_TOUCH_EN_OUT, 0);
	msleep(500);
	gpio_direction_output(GPIO_TOUCH_EN_OUT, 1);
	msleep(2000);
